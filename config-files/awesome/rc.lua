...
beautiful.init("/home/michal/.config/awesome/themes/red/theme.lua")
...
tags = 
{
    names  = { "1: Desktop", "2: Web", "3: Code", "4: Code-2", "5: IRC", "6: Other", "7: Settings", "8: tmp" },
    -- layout = { layouts[1], layouts[2], layouts[1], layouts[5], layouts[6],
        -- layouts[12], layouts[9], layouts[3], layouts[7]
}
for s = 1, screen.count() do
    -- Each screen has its own tag table.
    tags[s] = awful.tag(tags.names, s, awful.layout.suit.fair)
end
-- }}}
...
myawesomemenu = {
   ...
   { "edit awesome", editor_cmd .. " " .. awesome.conffile },
...
globalkeys = awful.util.table.join(
   ...
   awful.key({ modkey, }, "F5", function ()
    ...
    awful.key({ modkey, }, "F9", function ()
        awful.util.spawn("xcalib -c") end),
    awful.key({ modkey, }, "F10", function ()
        awful.util.spawn("xcalib -co 95 -a") end),
    ...
    awful.key({ modkey, }, "End", function ()
       awful.util.spawn("systemctl poweroff") end),
    awful.key({ modkey, }, "Home", function ()
       awful.util.spawn("systemctl suspend") end),
    awful.key({ modkey, }, "F6", function ()
       awful.util.spawn("systemctl reboot") end),
...
awful.key({  }, "XF86AudioPlay",function () awful.util.spawn( "mocp --play"  ) end)
